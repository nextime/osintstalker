...
def downloadWigle(lat,lng):
	...
	url = "http://wigle.net/gpsopen/gps/GPSDB/confirmquery/?variance="+str(variance)+"&latrange1="+lat1+"&latrange2="+lat2+"&longrange1="+lgn1+"&longrange2="+lgn2+"&lastupdt="+str(currentYear)+"0101000000&credential_0=keith55&credential_1=7914058&simple=true"	
